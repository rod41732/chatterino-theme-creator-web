import { useInsEditContext } from "@/app/components/InsEdit";
...
export function InspectorUI() {
    const { state, setState } = useInsEditContext();
            ...
            {mode == "main" ? (
                <div>
                    ...
                    <p className="text-sm text-gray-500">
                        Icon theme determines whether a theme is dark theme or
                        light theme. The editor background will also be changed
                        to be contrast with your theme.
                    </p>

                    <div className="font-bold text-lg mt-4 mb-1"> Tips </div>
                    <li>
                        Click on elements on the left side to customize theme.
                    </li>
                    ...
                    <Checkbox
                        ...
                        onChange={(e) => {
                            setData(
                                produce(data, (draft) => {
                                    draft.ctcMeta.simpleTabSettings =
                                        e.target.checked;
                                }),
                            );
                        }}
                ...
                <div>
                    <div className="flex items-center py-2 border-b border-b-gray-300 mb-2">
                        ...
                        <button
                            ...
                            onClick={() => {
                                setState({ mode: "main", widgets: [] });
                            }}
                        >
                            Done
                        </button>
                    </div>
                    {state.widgets.map((it, idx) => {
                        if (it.type == "divider") {
